...
var queries = {
 ...
 GET_PROJECTS_QUERY_TEMPLATE_2: "WITH qu AS ( " +
   "    WITH hull as ( " +
   "        SELECT  " +
   ...
   "            A.external_url AS agency_url, A.name AS agency_name, ST_AsGeoJSON(A.the_geom) AS agency_position,PWA.the_geom as the_geom " +
   "        FROM  " +
   ...
   "        GROUP BY  " +
   "            PWA.the_geom,P.nexso_code, P.cartodb_id, title, approval_date, fixed_approval_date,  " +
